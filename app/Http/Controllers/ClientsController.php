...
class ClientsController extends Controller
{
    ...
    public function anyData()
    {
        ...
        return Datatables::of($clients)
            ...
            ->add_column('edit', '
                <a href="{{ route(\'clients.edit\', $id) }}" class="btn btn-success" >Змінити</a>')
            ->add_column('delete', '
                <form action="{{ route(\'clients.destroy\', $id) }}" method="POST">
            <input type="hidden" name="_method" value="DELETE">
            <input type="submit" name="submit" value="Видалити" class="btn btn-danger" onClick="return confirm(\'Are you sure?\')"">
    ...
    public function update($id, UpdateClientRequest $request)
    {
        ...
        Session()->flash('flash_message', 'Клієнт успішно оновлений');
        return redirect()->route('clients.index');
    }
    ...
    public function updateAssign($id, Request $request)
    {
        ...
        Session()->flash('flash_message', 'Призначений новий користувач');
        return redirect()->back();
    }
