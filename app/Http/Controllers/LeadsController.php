...
class LeadsController extends Controller
{
    ...
    public function store(StoreLeadRequest $request)
    {
        ...
        Session()->flash('flash_message', 'Лід був створений');
    ...
    public function updateAssign($id, Request $request)
    {
        ...
        Session()->flash('flash_message', 'Новий користувач призначений');
    ...
    public function updateFollowup(UpdateLeadFollowUpRequest $request, $id)
    {
        ...
        Session()->flash('flash_message', 'Призначена нова дата');
        return redirect()->back();
    }
    ...
    public function updateStatus($id, Request $request)
    {
        ...
        Session()->flash('flash_message', 'Лід був виконаний');
        return redirect()->back();
    }
}
