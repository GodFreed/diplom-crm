...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Початок",sLast:"Кінець",sNext:"Далі",sPrevious:"Назад"},sEmptyTable:"Жодних даних у таблиці",sInfo:"Показано з _START_ до _END_ з _TOTAL_ записів",sInfoEmpty:"Показано 0 по 0 з 0 записів",sInfoFiltered:"(відфільтровано з _MAX_ загальних записів)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показано _MENU_ записів",sLoadingRecords:"Завантаження...",sProcessing:"Processing...",sSearch:"Пошук:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Не знайдено записів"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
